...
class ElevenLabsManager:
    ...
    def text_to_audio(self, input_text, voice="Fake Pajama Sam", save_as_wave=True, subdirectory=""):
    ...
    def text_to_audio_played(self, input_text, voice="Fake Pajama Sam"):
        audio = generate(
          text=input_text,
          voice=voice,
          model="eleven_monolingual_v1"
    ...
    def text_to_audio_streamed(self, input_text, voice="Fake Pajama Sam"):
